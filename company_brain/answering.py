...
def _system_prompt(answer_style: str = "case") -> str:
    ...
    if answer_style == "case_open":
        section_prompt = (
            ...
            "only a separate regulation/reference file where the regulation reference "
            "appears; never cite the opened case file itself as the Regulation Source. Keep Risks "
